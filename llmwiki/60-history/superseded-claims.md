...
the legend. That rule is a requirement, not a description of what ships: nothing in the
code enforces it, and [README's ladder](../README.md#the-rule-is-not-enforced-anywhere-in-the-code)
gives the procedure for deriving which writes currently violate it.
