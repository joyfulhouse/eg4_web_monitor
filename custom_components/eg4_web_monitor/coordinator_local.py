    ...
    async def _read_modbus_parameters(self, transport: Any) -> dict[str, Any]:
        ...
        try:
            ...
            register_ranges = [
                ...
                (151, 4),  # AC coupling start/end SOC + start/end voltage (12000XP)
            ...
            key_params = {
                ...
                in (
                    ...
                    "HOLD_AC_COUPLE_START_SOC",  # AC Coupling Start SOC (reg 151)
                    "HOLD_AC_COUPLE_END_SOC",  # AC Coupling End SOC (reg 152)
                    "HOLD_AC_COUPLE_START_VOLT",  # AC Coupling Start Voltage (reg 153)
                    "HOLD_AC_COUPLE_END_VOLT",  # AC Coupling End Voltage (reg 154)
