...
SENSOR_TYPES = {
    ...
    # Power factor (0.0-1.0 ratio; cloud "pf" + Modbus reg 19). Unitless per the
    # POWER_FACTOR device class. Cloud-derived in HTTP mode, transport in LOCAL.
    "power_factor": {
        "name": "Power Factor",
    ...
    "generator_energy_lifetime": {
        "name": "Generator Energy Lifetime",
        "unit": UnitOfEnergy.KILO_WATT_HOUR,
        "device_class": "energy",
        "state_class": "total_increasing",
        "icon": "mdi:engine",
