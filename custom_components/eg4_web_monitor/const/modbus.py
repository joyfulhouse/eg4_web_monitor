...
# AC charge start/end SOC parameter names (registers 160-161)
PARAM_HOLD_AC_CHARGE_START_SOC = "HOLD_AC_CHARGE_START_BATTERY_SOC"
PARAM_HOLD_AC_CHARGE_END_SOC = "HOLD_AC_CHARGE_END_BATTERY_SOC"

# AC charge start/end voltage parameter names (registers 158-159)
