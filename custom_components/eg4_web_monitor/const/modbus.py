...
PARAM_FUNC_AC_COUPLE_EN = "FUNC_AC_COUPLE_EN"
PARAM_FUNC_BATTERY_ECO_EN = "FUNC_BATTERY_ECO_EN"  # Register 110, bit 15
...
# Forced discharge parameter names (registers 82-83)
PARAM_HOLD_FORCED_DISCHG_POWER_CMD = "HOLD_FORCED_DISCHG_POWER_CMD"
PARAM_HOLD_FORCED_DISCHG_SOC_LIMIT = "HOLD_FORCED_DISCHG_SOC_LIMIT"

# AC charge start/end parameter names (registers 158-161)
PARAM_HOLD_AC_CHARGE_START_VOLTAGE = "HOLD_AC_CHARGE_START_VOLTAGE"
PARAM_HOLD_AC_CHARGE_END_VOLTAGE = "HOLD_AC_CHARGE_END_VOLTAGE"
PARAM_HOLD_AC_CHARGE_START_BATTERY_SOC = "HOLD_AC_CHARGE_START_BATTERY_SOC"
PARAM_HOLD_AC_CHARGE_END_BATTERY_SOC = "HOLD_AC_CHARGE_END_BATTERY_SOC"
